...
## 「チームビルディング」セッションの目的
LED-Camp のオンラインコミュニケーションのセッションの次はチームビルディングです。このセッションの目的は、オンラインコミュニケーションと同じく、感じている不安をできるだけ軽くし、本来学ぶべきことに集中できるような状態することです。

本セッションも、当日は座学がほとんどありません。代わりに数多くのワークを実施します。事前にこのテキストを読み、LED-Camp 当日のワークに臨むことによって、これらワークの狙いや目的をより深く感じ取ることができると考えています。
